    ...
    <div className="bg-gray-100 text-gray-900">
      ...
      <section className="relative h-[500px] text-white flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="text-center">
            <h1 className="text-5xl font-extrabold mb-4">Transform Your Complaints</h1>
            <p className="text-lg mb-8">Effortlessly categorize and analyze complaints with our advanced AI-powered tool.</p>
            ...
            <div className="relative bg-gray-200 rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 h-96">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 transition-opacity hover:opacity-100">
                <div className="text-center text-white p-6">
                  ...
                  <p className="text-lg">Get our analysis responses in a matter of seconds.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-gray-200 rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 h-96">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 transition-opacity hover:opacity-100">
                <div className="text-center text-white p-6">
                  ...
                  <p className="text-lg">Get detailed analysis and insights with advanced AI algorithms.</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-gray-200 rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105 h-96">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 transition-opacity hover:opacity-100">
                <div className="text-center text-white p-6">
                  ...
                  <p className="text-lg">Enjoy a clean and intuitive interface that’s easy to navigate.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-8">Efficiency and Speed in Every Decision</h2>
          <p className="text-lg mb-12">Discover how our solution benefits different types of users.</p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md flex flex-col items-center">
              <div className="w-16 h-16 mb-4 flex items-center justify-center bg-yellow-500 rounded-full">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M3 6h18M3 14h18m-8 4h8M5 18h4m4-12H5m0 4h8m-4-4v8m4-4v4" />
                </svg>
              </div>
              <h3 className="text-2xl font-semibold mb-4">For Businesses</h3>
              <p className="text-lg mb-4">Boost operational efficiency by analyzing user complaints to streamline processes and improve satisfaction.</p>
            </div>

            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md flex flex-col items-center">
              <div className="w-16 h-16 mb-4 flex items-center justify-center bg-yellow-500 rounded-full">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v7l5 2.5m-5-2.5l-5 2.5V5m0 0h10m-10 0L12 3m0 0l10 5m-10-5v7" />
                </svg>
              </div>
              <h3 className="text-2xl font-semibold mb-4">For Schools</h3>
              <p className="text-lg mb-4">Enhance student feedback analysis by examining patterns and trends in similar complaints to foster a better learning environment.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-yellow-500 text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="text-lg mb-8">Start analyzing complaints today with our powerful AI-driven solutions.</p>
        ...
        <div className="container mx-auto px-8 flex flex-col items-center">
          ...
          <Accordion type="single" collapsible className="w-full max-w-xl">
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>In what form can I send a complaint?</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Your input is analyzed by our AI and also compared for similar ones.
              </AccordionContent>
            </AccordionItem>
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-6 text-center">
          <p className="mb-4">&copy; {new Date().getFullYear()} SortItOut. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
